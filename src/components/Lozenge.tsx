...
const LozengeChoices: Record<LozengeProps, LozengeDetails> = {
  ...
  wip: { bgColor: "#f9a8d4", text: "WIP" }, // bg-pink-300
  ...
  adv: { bgColor: "#5b21b6", text: "Advanced", color: "#fafafa" }, // bg-violet-800
};
...
const Lozenge = ({ t, p }: { t: LozengeProps, p?: Boolean }) => {
  ...
  return (
    <span
      className="font-bold rounded-full py-[4px] px-[8px] text-xs relative -top-[3px] "
      style={{
